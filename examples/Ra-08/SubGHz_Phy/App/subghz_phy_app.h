...
/* Ra-08 transparent firmware compatibility:
 * local address must match the sender's AT+CTXADDRSET target address.
 */
#define RA08_TRANSPARENT_COMPAT                     1
#define RA08_DEFAULT_LOCAL_ADDR                     12U
#define RA08_DEFAULT_TARGET_ADDR                    13U

#if (( USE_MODEM_LORA == 1 ) && ( USE_MODEM_FSK == 0 ))
#define LORA_BANDWIDTH                              2         /* [0: 125 kHz, 1: 250 kHz, 2: 500 kHz, 3: Reserved] */
#define LORA_SPREADING_FACTOR                       5         /* [SF5..SF12] */
#define LORA_CODINGRATE                             2         /* [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8] */
#define LORA_PREAMBLE_LENGTH                        8         /* Matches Ra-08 transparent firmware */
